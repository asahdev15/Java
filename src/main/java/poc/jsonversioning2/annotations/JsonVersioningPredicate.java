...
public class JsonVersioningPredicate {
    ...
    static private boolean isWithinVersion(JsonSince since, JsonUntil until, Version jsonVersion) {
        ...
        Version sinceVersion = since == null ? null : poc.jsonversioning2.annotations.Version.fromString(since.value());
        Version untilVersion = until == null ? null : poc.jsonversioning2.annotations.Version.fromString(until.value());
