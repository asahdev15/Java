...
public class Version implements Comparable<Version> {
    public static final String JsonVersionConfigDeserializing = "jsonversioning2.annotations.json_version_deserializing";
    public static final String JsonVersionConfigSerializing = "jsonversioning2.annotations.json_version_serializing";
