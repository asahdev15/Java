package xdatastructures.graphs.minimumspanningtree;

import xdatastructures.graphs.node.WeightedNode;
...
public class Prims {
	...
	void prims(WeightedNode node) {
		...
		while (!queue.isEmpty()) {
			WeightedNode presentNode = queue.poll(); // Remove vertex which has min distance
